...
def main():
    ...
    bt_train_acc = bt_accuracy(bt_ratings, train_matchups, train_outcomes, draw_margin=draw_margin)
    bt_test_acc = bt_accuracy(bt_ratings, test_matchups, test_outcomes, draw_margin=draw_margin)
