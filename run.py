...
from elo import compute_elo, compute_mle_elo, predict_win_rate, predict_probs, pretty_print_elo_ratings
...
def main():
    ...
    train_matches = train_matches.reset_index()
    ...
    mle_ratings = compute_mle_elo(train_matches)
